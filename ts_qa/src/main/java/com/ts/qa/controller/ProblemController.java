...
public class ProblemController {
	...
	public PageResult newListByLabelId(@PathVariable String labelid,
	...
	public PageResult hotListByLabelId(@PathVariable String labelid,
									   @PathVariable int page,@PathVariable int size){
	...
	public PageResult waitListByLabelId(@PathVariable String labelid,
									   @PathVariable int page,@PathVariable int size){
